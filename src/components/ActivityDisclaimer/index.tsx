...
export function ActivityDisclaimer({ visible, onClose, onAgree }: ActivityDisclaimerProps) {
  return (
    <AnimatedModal
      visible={visible}
      onClose={onClose}
      maskClassName="activity-bike-index-modal"
      bodyClassName="activity-bike-index-disclaimerModal"
    >
      ...
      <ScrollView scrollY className="activity-bike-index-disclaimerScroll">
        <View className="activity-bike-index-disclaimerSection">
          ...
          <Text className="activity-bike-index-disclaimerText">
            1. 骑友输入的名称及电话号将会加密后以 张大三
            <Text className="activity-bike-index-disclaimerEm">(张**)</Text>
            15508186565
            <Text className="activity-bike-index-disclaimerEm">(1550818****)</Text>
            {' '}进行展示，为方便联系请输入真实信息
          </Text>
          <Text className="activity-bike-index-disclaimerText">
            2. 仅<Text className="activity-bike-index-disclaimerEm">活动创建者</Text>
            可根据创建时名称及电话号查看参与者完整报名信息用于活动联系(请自行核对活动发布者身份)
          </Text>
          <Text className="activity-bike-index-disclaimerText">
        ...
        <View className="activity-bike-index-disclaimerSection">
          <Text className="activity-bike-index-disclaimerHeading">免责声明</Text>
          <Text className="activity-bike-index-disclaimerText">
          ...
          <Text className="activity-bike-index-disclaimerText">
            2.凡报名参加者均视为具有完全民事行为能力的人,如在活动中发生人身损害后果,团队的发起者和同行者不承担赔偿责任,由被损害人依据法律规定和本《免责条款》声明依法解决,凡报名者均视为接受本声明。代他人报名者,被代者如在活动中遭受人身损害,领队同样不承担任何赔偿责任。
          </Text>
          <Text className="activity-bike-index-disclaimerText">
            3.本人必须遵守《中华人民共和国道路交通安全法》等国家法律法规，严格遵守交通规则，采取一切措施避免给本人或他人造成人身或财产的损失，以及避免承担法律上的责任。如本人未尽上述义务，由此引起的一切责任均由本人承担。
          </Text>
          <Text className="activity-bike-index-disclaimerText">
            4.本人清楚活动过程中，可能因为运输及摆放停靠，意外摔车等可能造成单车损伤，本人不会对上述原因造成的单车损伤追究活动参与者和组织者的责任。
          </Text>
          <Text className="activity-bike-index-disclaimerText">
            5.该免责声明目的是为活动发起人组织者和同行者再次明确户外活动的风险,提高自律能力和抗风险能力,免除一些不必要的后果,让户外活动更安全!凡参加此次活动者视为认可此声明。
          </Text>
          <Text className="activity-bike-index-disclaimerText">
